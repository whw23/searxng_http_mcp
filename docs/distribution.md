...
Tracking all platforms where searxng-http-mcp is published, submitted, or planned.
...
| Channel | Status |
|---------|--------|
| Reddit (r/ClaudeAI, r/selfhosted) | Not posted |
| Hacker News (Show HN) | Not posted |
| X/Twitter | Not posted |
| Discord (Claude, MCP communities) | Not posted |
