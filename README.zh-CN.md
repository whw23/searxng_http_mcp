...
<tbody>
  ...
  <tr><td>AI 编程代理插件</td><td align="center">&#9989;</td><td align="center">&#10060;</td><td align="center">&#10060;</td><td align="center">&#10060;</td><td align="center">&#9989;</td><td align="center">&#9989;</td></tr>
...
我们选择把精力投入到竞品缺失的方向：**完整的 SearXNG API 覆盖**（分类、自动补全、引擎元数据 — 大多数封装都没有暴露这些能力），以及**自包含部署、认证、Web UI 反向代理和 AI 编程代理插件集成（Claude Code / Copilot CLI / Codex CLI）**。
...
兼容 **Claude Code**、**GitHub Copilot CLI** 和 **OpenAI Codex CLI**。添加市场，然后安装适合你环境的插件：
